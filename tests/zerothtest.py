...
class Test_check_contradict(test.TestCase):
    ...
    def test_true_basic(self):
        self.assertIs(zol.check_contradict('<not_~><sentvar_p>', '<sentvar_p>'), True)

    def test_false_basic(self):
        self.assertIs(zol.check_contradict('<sentvar_p>', '<sentvar_p>'), False)

    def test_double_neg(self):
        self.assertIs(zol.check_contradict('<not_~><not_~><sentvar_p>', '<sentvar_p>'), False)

    def test_true_notation_change(self):
        self.assertIs(zol.check_contradict('<not_not><sentvar_p>', '<sentvar_p>'), True)
    ...
    def test_true_reversed(self):
        self.assertIs(zol.check_contradict('<sentvar_p>', '<not_~><sentvar_p>'), True)
